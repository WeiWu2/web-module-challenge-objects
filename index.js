...
function createMenuItem(newName, newPrice, newCategory){
  let newMenu = {name:newName, price:newPrice, category:newCategory};
  return newMenu;
}
...
console.log(createMenuItem("noodles", "4", "lunch"));
console.log(createMenuItem("pizza", "2", "dinner"));
/* 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 2: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀
...
export const burger = {
  ...
  category: "Lunch", 
  /*Your code here*/
  discount: function(discounting){
    if(discounting.includes('teacher') || discounting.includes('student'))
...
*/
reviews.push({name: "Wei", rating: 1, feedback:"bad code"});
console.log(reviews);
